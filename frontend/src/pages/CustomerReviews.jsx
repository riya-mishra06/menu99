    ...
    <div className="reviews-page">
      <header className="reviews-header">
        ...
        <div className="header-right">
          ...
          <div className="cafe-open-toggle">
            Open <div className="toggle-switch"></div>
          </div>
        </div>
      </header>
            ...
            <div key={review.id} className="review-card">
              ...
              <div className="review-body">
                <div className="review-top">
                  ...
                  {!review.reply && (
                    <button className="reply-btn"><MessageSquare size={13} /> Reply</button>
                  )}
                </div>
                ...
                {review.reply && (
                  <button className="reply-btn" style={{marginTop: '8px'}}><MessageSquare size={13} /> Edit Reply</button>
                )}
              </div>
            </div>
          ))}
